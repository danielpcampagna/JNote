...
public class JsonDaoTest {
	...
	*/
	/*
	@Test
	public void test02_salvar_root() throws IllegalArgumentException, IOException, JSONException {
		Map<String, Object> oracle = new HashMap<String, Object>();
        List<Object> oracleValue = new ArrayList<Object>();
        Map<String, Object> oracleValueNome = new HashMap<String, Object>();
        Map<String, Object> oracleValueIdade = new HashMap<String, Object>();
        ...
        jsonDao.salvar(oracle, true);
        
	}
	*/
	
	@Test
	public void test03_remover_root() throws IllegalArgumentException, IOException, JSONException {
		JsonDao jsonDao = new JsonDao();
		jsonDao.remover("JNote.a.b.favoritas", true);
	}
